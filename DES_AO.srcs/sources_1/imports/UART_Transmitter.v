`timescale 1ns / 1ps
/* Base Module downloaded from
https://www.instructables.com/id/UART-Communication-on-Basys-3-FPGA-Dev-Board-Power-1/
It has been edited to fit the current project
*/
...
output reg packetSentSignal // Signal for one clock cycle to indicate that a full packet is transmitted
    );
