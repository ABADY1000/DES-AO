...
HD_PWD='D:/Official/College/Eng 2019/EE460/project/DES-AO/DES_AO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UARTReciever.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UARTReciever.tcl
