...
HD_PWD='D:/Official/College/Eng 2019/EE460/project/DES-AO/DES_AO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UARTReciever.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UARTReciever.tcl -notrace
